...
(function() {
   ...
   */
  angular.module('goaldenAppApp').directive('pzTime', timeDirective);
  ...
  function timeDirective() {
    return {
      ...
      require: ['ngModel', 'pzTime'],
      controller: CalendarCtrl,
      controllerAs: 'ctrl',
      bindToController: true,
      link: function(scope, element, attrs, controllers) {
        var ngModelCtrl = controllers[0];
        var pzTimeCtrl = controllers[1];
        pzTimeCtrl.configureNgModel(ngModelCtrl);
      }
    };
  }
  ...
  /**
   * Controller for the pzTime component.
